...
<script type="text/javascript">
	function deleteConfirm(placeno){
		if (confirm("해당 맛집을 삭제합니다.")==true)
			location.href="deleteplace.jsp?placeno=" +placeno;
		else
			return;
	}
</script>
	...
	<div class="container">
		<div class="row" align="center">
			...
			<div class="col-md-7">
				...
				%>
					<a href ="#" onclick="deleteConfirm('<%=rs.getString("placeno") %>')"
